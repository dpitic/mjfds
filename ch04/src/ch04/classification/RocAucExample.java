...
public class RocAucExample {
    ...
    private static void generatedExample() {
        int n = 1000;
        Random rnd = new Random(5);
        double[] score = IntStream.range(0, n).mapToDouble(i ->
                rnd.nextDouble() * i / n).toArray();
    ...
    private static double maybeFlip(double d, double prob, Random rnd) {
